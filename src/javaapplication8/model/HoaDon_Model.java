...
public class HoaDon_Model {
    ...
    public HoaDon_Model(int id, String maHD, int idKH, int idNV, int idPGG, int idTT, String tenKhachHang, String maNV, String ngayTao, String sdtKH, String tongTien, String tongTienKhiGiam, String diaChiKhachHang, boolean trangThai) {
        this.id = id;
        this.maHD = maHD;
        this.idKH = idKH;
        this.idNV = idNV;
